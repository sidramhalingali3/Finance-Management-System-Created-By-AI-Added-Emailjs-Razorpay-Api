...
<body>
    <div class="container">
        <div class="header-actions">
            ...
            <div>
                <a href="addFinance" class="btn" style="margin-right: 20px; width: auto;">+ Collect EMI Payment</a>
        ...
        <% if ("verified".equals(request.getParameter("success"))) { %>
            <div class='alert alert-success'>Payment verified successfully!</div>
        <% } %>
                                    ...
                                    <td data-label="Action">
                                        <% if ("Pending".equals(currentStatus)) { %>
                                            <div style="display: flex; gap: 5px;">
                                                <form action="verifyPayment" method="post" style="margin: 0;">
                                        ...
                                        <% } else { %>
                                            <span style="color: #475569; font-size: 0.875rem;">Completed</span>
                                        <% } %>
                                    </td>
                                </tr>
                    <%
