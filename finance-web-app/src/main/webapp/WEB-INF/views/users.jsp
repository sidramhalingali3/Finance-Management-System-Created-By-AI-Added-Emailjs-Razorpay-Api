...
<body>
    <div class="container">
        <div class="header-actions">
            ...
            <div>
                <a href="addUser" class="btn" style="margin-right: 10px; background-color: #3b82f6;">+ Create User</a>
                ...
                <tbody>
                    <%
                        ...
                        if (users != null && !users.isEmpty()) {
                            for (User u : users) {
                                String rowColor = "color: #10b981;";
                                if ("Admin".equals(u.getRole())) {
                                    rowColor = "color: #a855f7;";
                                } else if ("Collector".equals(u.getRole())) {
                                    rowColor = "color: #3b82f6;";
                                }
                    %>
                                <tr>
                                    <td data-label="ID"><%= u.getId() %></td>
                                    <td data-label="Username"><strong><%= u.getUsername() %></strong></td>
                                    <td data-label="Password"><span style="filter: blur(3px); transition: filter 0.3s;" onmouseover="this.style.filter='none'" onmouseout="this.style.filter='blur(3px)'"><%= u.getPassword() %></span></td>
                                    <td data-label="Role" style="<%= rowColor %> font-weight: bold;"><%= u.getRole() %></td>
                                    <td data-label="Action">
                                        <% if (!"Admin".equals(u.getRole())) { %>
                                            <a href="deleteUser?id=<%= u.getId() %>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this user?');">Delete</a>
                                        <% } else { %>
