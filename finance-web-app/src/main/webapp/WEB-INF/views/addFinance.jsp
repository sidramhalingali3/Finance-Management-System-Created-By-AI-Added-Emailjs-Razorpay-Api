...
<body>
    <div class="container login-container" style="max-width: 500px;">
        <div class="header-actions" style="margin-bottom: 1.5rem; padding-bottom: 0.5rem;">
            ...
            <a href="collector" class="btn btn-outline" style="padding: 0.5rem 1rem; font-size: 0.875rem;">&larr; Back</a>
        </div>

        <% 
            String error = request.getParameter("error");
            if (error != null && !error.isEmpty()) {
                if ("insert_failed".equals(error)) {
        %>
                    <div class='alert alert-error'>Failed to add record. Please try again.</div>
        <%      } else { %>
        ...
        <form action="addFinance" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" id="description" name="description" required placeholder="e.g. EMI Payment, Partial Payment">
            </div>
            ...
            <div class="form-group" style="padding: 10px; background: rgba(255,255,255,0.05); border-radius: 5px; margin-bottom: 15px;">
                ...
                <strong style="color: #10b981;">Today</strong>
            </div>
