...
<body>
    <div class="container">
        <div class="header-actions">
            ...
            <div>
                <a href="razorpayPayment" class="btn" style="margin-right: 15px; width: auto; background: linear-gradient(135deg, #0284c7, #2563eb);"><i class="fa-solid fa-shield-halved"></i> Pay Online (Razorpay)</a>
                <a href="phonepePayment" class="btn" style="margin-right: 15px; width: auto; background-color: #5f259f;">Pay via PhonePe / UPI</a>
                <a href="logout" class="btn btn-outline">Logout</a>
            </div>
        </div>

        <% if ("true".equals(request.getParameter("success"))) { %>
            <div class='alert alert-success'>Finance record added successfully!</div>
        <% } %>
        ...
        <%
            ...
            if (loanList != null) {
                for (Loan loan : loanList) {
                    myLoanAmount += (loan.getLoanAmount() != null) ? loan.getLoanAmount() : 0;
                    myPaidAmount += (loan.getPaidAmount() != null) ? loan.getPaidAmount() : 0;
                    myRemaining += (loan.getRemainingAmount() != null) ? loan.getRemainingAmount() : 0;
                }
            }
        ...
        <div style="display: flex; gap: 20px; flex-wrap: wrap; margin-bottom: 30px;">
            <div class="card" style="flex: 1; padding: 20px; background: rgba(59, 130, 246, 0.1); border-radius: 12px; border-left: 4px solid #3b82f6;">
                <h4 style="margin: 0; color: #475569; font-weight: normal;">Total Loan Amount</h4>
            ...
            <div class="card" style="flex: 1; padding: 20px; background: rgba(16, 185, 129, 0.1); border-radius: 12px; border-left: 4px solid #10b981;">
                <h4 style="margin: 0; color: #475569; font-weight: normal;">Paid Amount</h4>
            ...
            <div class="card" style="flex: 1; padding: 20px; background: rgba(239, 68, 68, 0.1); border-radius: 12px; border-left: 4px solid #ef4444;">
                <h4 style="margin: 0; color: #475569; font-weight: normal;">Remaining Balance</h4>
                ...
                <tbody>
                    <%
                        if (financeList != null && !financeList.isEmpty()) {
                            for (Finance f : financeList) {
                                ...
                                String collector = (f.getCollector() != null && !f.getCollector().isEmpty()) ? f.getCollector() : "N/A";
                    ...
                    %>
                                <tr>
                                    ...
                                    <td data-label="Collector"><%= collector %></td>
                    ...
                    %>
                            <tr><td colspan='9' style='text-align:center;'>You haven't added any records yet.</td></tr>
                    <%
                        }
                    %>
                </tbody>
